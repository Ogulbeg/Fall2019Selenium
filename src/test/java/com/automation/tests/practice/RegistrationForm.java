...
public class RegistrationForm {
    ...
    public void test1() {
        ...
        driver.findElement(passwordBy).sendKeys("superSecret56");
        driver.findElement(phoneBy).sendKeys("234-234-1234");
        driver.findElement(femaleBy).click();
        driver.findElement(dateOfBirthBy).sendKeys("07/22/1992");
